...
import StaffActivationTab from "./activation/StaffActivationTab";
import StaffDistributionTab from "./activation/StaffDistributionTab";

export default function StaffLocalAuthManager() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-1">
                    ...
                    <p className="text-lg text-slate-500 dark:text-slate-400">
                        Manage staff identities and portal entry credentials.
                    </p>
                </div>
            </div>
            ...
            {activeTab === "activation" ? (
                <StaffActivationTab onSuccess={() => setActiveTab("distribution")} />
            ) : (
                <StaffDistributionTab />
            )}
        </div>
    );
}
